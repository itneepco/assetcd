...
@Component({
  selector: 'app-rej-status',
  templateUrl: './rej-status.component.html',
  styleUrls: ['./rej-status.component.scss']
})
export class RejStatusComponent implements OnInit {
  ...
  generateReport1() {
    ...
    if (projCodes.length > 0) {
      this.reportService.rejStatusReport(projCodes)
                      .subscribe(
                       res  => {
